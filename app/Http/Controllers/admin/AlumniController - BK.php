...
class AlumniController extends Controller
{
	...
	{ 
		$data = array();
		$html = '';
		if ($request->departm != 'College' && $request->select_all != 'select_all') {
		...
		{
			if (isset($request->departm) && isset($request->select_all) && $request->departm != 'College') 
			{
		...
		if ($request->response == 'response' || $request->select_all == 'select_all' && isset($request->departm) && $request->departm != 'College') {
			$total_gender = 0;
		...
		if ($request->year || $request->response == 'response' || $request->select_all == 'select_all') {
			...
			if ($request->year != '' && $request->response != 'response' && $request->select_all != 'select_all') {
				...
				$data['graduation']['2017-2018'] = Alumni::where('graduation','2017-2018')->count();
				$data['graduation']['2018-2019'] = Alumni::where('graduation','2018-2019')->count();
				$data['graduation']['2019-2020'] = Alumni::where('graduation','2019-2020')->count();
				$data['graduation']['2020-2021'] = Alumni::where('graduation','2020-2021')->count();
				$data['graduation']['2021-2022'] = Alumni::where('graduation','2021-2022')->count();
			}
