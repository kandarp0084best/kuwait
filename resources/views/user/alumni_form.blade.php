...
<div class="container pt-5 pb-5">
	<div class="form_box">
		...
		<div id="alumni">
			...
			<form name="alumni" method="post" onsubmit="return false;">
				...
				<div class="row mb-3">
					...
					<div class="col-md-12 mb-3">
						<div class="form-group mb-3">
						    ...
						    <div class="form-group form-check-inline">
							    <input type="radio" value="None" name="degrees" class="form-check-input"  >
					...
					<div class="col-md-12 mb-3">
						<div class="form-group mb-3">
						    ...
						    <div class="form-group form-check-inline">
							    <input type="radio" value="Employed (none-engineering)" name="employment_status" class="form-check-input"  >
							    <label class="form-check-label">Employed (none-engineering)</label>
						    </div>
						 </div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<p>Thank you for completing the survey. Your participation is appreciated.</p>
					</div>
				</div>
